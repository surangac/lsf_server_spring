 ...
 * Alternative implementation to WebClientIntegrationService
 */
@Service
@Primary
public class RestTemplateIntegrationService implements IntegrationService {

    private static final Logger log = LoggerFactory.getLogger(RestTemplateIntegrationService.class);
    ...
    private String mapProducerNameToUrl(String producerName, String defaultUrl) {
        ...
        producerUrlMap.put(IntegrationConstants.PRODUCER_OMS_TRADING, 
                omsBaseUrl + IntegrationConstants.OMS_TRADING_ACCOUNT_ENDPOINT);
        
        // Legacy producer mappings for backward compatibility
        producerUrlMap.put("http_producer_to_OMS_for_trading", 
                omsBaseUrl + IntegrationConstants.OMS_TRADING_ACCOUNT_ENDPOINT);
        
        // Map HTTP producers from LsfConstants
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_CUSTOMER_INFO, 
                omsBaseUrl + IntegrationConstants.OMS_CUSTOMER_INFO_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_CASH_ACCOUNT_RELATED, 
                omsBaseUrl + IntegrationConstants.OMS_CASH_ACCOUNT_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_PORTFOLIO_RELATED, 
                omsBaseUrl + IntegrationConstants.OMS_PORTFOLIO_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_SYMBOL_RELATED, 
                omsBaseUrl + IntegrationConstants.OMS_SYMBOL_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_REQ_VALIDATE_SSO, 
                omsBaseUrl + IntegrationConstants.OMS_VALIDATE_SSO_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_PURCHASE_ORDER, 
                omsBaseUrl + IntegrationConstants.OMS_PURCHASE_ORDER_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_B2B_RELATED, 
                omsBaseUrl + IntegrationConstants.OMS_B2B_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_COMMON_REQUEST_RELATED, 
                omsBaseUrl + IntegrationConstants.OMS_COMMON_REQUEST_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_OMS_VALIDATION_RELATED, 
                omsBaseUrl + IntegrationConstants.OMS_VALIDATION_ENDPOINT);
        
        // Notification producers
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_SMS_RELATED, 
                notificationBaseUrl + IntegrationConstants.SMS_ENDPOINT);
        producerUrlMap.put(LsfConstants.HTTP_PRODUCER_EMAIL_RELATED, 
                notificationBaseUrl + IntegrationConstants.EMAIL_ENDPOINT);
