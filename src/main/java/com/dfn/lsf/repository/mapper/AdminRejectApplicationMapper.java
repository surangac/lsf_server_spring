 ...
 */
public class AdminRejectApplicationMapper implements RowMapper<MurabahApplication> {
    @Override
    public MurabahApplication mapRow(ResultSet resultSet, int i) throws SQLException {
